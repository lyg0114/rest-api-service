...
public class SwaggerConfig {
  private static final Contact DEFAULT_CONTACT
      = new Contact("YGLEE", "http://www.yglee.com", "younggyo0114@gmail.com");

  private static final ApiInfo DEFAULT_API_INFO
      = new ApiInfo("Awesom API Title", "My User management REST API service", "1.0", "urn:tos",
      DEFAULT_CONTACT, "Apache 2.0", "http://www.apache.org/liceneces/LICENSE-2.0",
      new ArrayList<>());
